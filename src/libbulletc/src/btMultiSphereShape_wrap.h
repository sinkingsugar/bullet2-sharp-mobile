...
extern "C"
{
	EXPORT btMultiSphereShape* btMultiSphereShape_new(btScalar* positions, btScalar* radi, int numSpheres);
	EXPORT btMultiSphereShape* btMultiSphereShape_new2(btVector3* positions, btScalar* radi, int numSpheres);
