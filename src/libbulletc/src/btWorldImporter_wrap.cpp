...
btCollisionShape* btWorldImporter_createBoxShape(btWorldImporter* obj, btScalar* halfExtents)
{
...
btCollisionObject* btWorldImporter_createCollisionObject(btWorldImporter* obj, btScalar* startTransform, btCollisionShape* shape, char* bodyName)
{
...
btConeTwistConstraint* btWorldImporter_createConeTwistConstraint2(btWorldImporter* obj, btRigidBody* rbA, btRigidBody* rbB, btScalar* rbAFrame, btScalar* rbBFrame)
{
	TRANSFORM_CONV(rbAFrame);
...
btHingeConstraint* btWorldImporter_createHingeConstraint(btWorldImporter* obj, btRigidBody* rbA, btRigidBody* rbB, btScalar* rbAFrame, btScalar* rbBFrame, bool useReferenceFrameA)
{
	TRANSFORM_CONV(rbAFrame);
	TRANSFORM_CONV(rbBFrame);
...
btHingeConstraint* btWorldImporter_createHingeConstraint2(btWorldImporter* obj, btRigidBody* rbA, btRigidBody* rbB, btScalar* rbAFrame, btScalar* rbBFrame)
{
	TRANSFORM_CONV(rbAFrame);
	TRANSFORM_CONV(rbBFrame);
...
btHingeConstraint* btWorldImporter_createHingeConstraint3(btWorldImporter* obj, btRigidBody* rbA, btScalar* rbAFrame, bool useReferenceFrameA)
{
	TRANSFORM_CONV(rbAFrame);
	return obj->createHingeConstraint(*rbA, TRANSFORM_USE(rbAFrame), useReferenceFrameA);
}

btHingeConstraint* btWorldImporter_createHingeConstraint4(btWorldImporter* obj, btRigidBody* rbA, btScalar* rbAFrame)
{
	TRANSFORM_CONV(rbAFrame);
...
btMultiSphereShape* btWorldImporter_createMultiSphereShape(btWorldImporter* obj, btScalar* positions, btScalar* radi, int numSpheres)
{
...
btCollisionShape* btWorldImporter_createPlaneShape(btWorldImporter* obj, btScalar* planeNormal, btScalar planeConstant)
{
...
btScaledBvhTriangleMeshShape* btWorldImporter_createScaledTrangleMeshShape(btWorldImporter* obj, btBvhTriangleMeshShape* meshShape, btScalar* localScalingbtBvhTriangleMeshShape)
{
...
btSliderConstraint* btWorldImporter_createSliderConstraint(btWorldImporter* obj, btRigidBody* rbB, btScalar* frameInB, bool useLinearReferenceFrameA)
{
	TRANSFORM_CONV(frameInB);
	return obj->createSliderConstraint(*rbB, TRANSFORM_USE(frameInB), useLinearReferenceFrameA);
}

btSliderConstraint* btWorldImporter_createSliderConstraint2(btWorldImporter* obj, btRigidBody* rbA, btRigidBody* rbB, btScalar* frameInA, btScalar* frameInB, bool useLinearReferenceFrameA)
{
	TRANSFORM_CONV(frameInA);
	TRANSFORM_CONV(frameInB);
...
btCollisionShape* btWorldImporter_getCollisionShapeByName(btWorldImporter* obj, char* name)
{
...
btTypedConstraint* btWorldImporter_getConstraintByName(btWorldImporter* obj, char* name)
{
	return obj->getConstraintByName(name);
}

const char* btWorldImporter_getNameForPointer(btWorldImporter* obj, void* ptr)
{
...
btRigidBody* btWorldImporter_getRigidBodyByName(btWorldImporter* obj, char* name)
{
...
void btWorldImporter_setDynamicsWorldInfo(btWorldImporter* obj, btScalar* gravity, btContactSolverInfo* solverInfo)
{
