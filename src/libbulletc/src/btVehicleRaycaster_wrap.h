...
extern "C"
{
	...
	EXPORT void btVehicleRaycaster_btVehicleRaycasterResult_setHitNormalInWorld(btVehicleRaycaster_btVehicleRaycasterResult* obj, btScalar* value);
	EXPORT void btVehicleRaycaster_btVehicleRaycasterResult_setHitPointInWorld(btVehicleRaycaster_btVehicleRaycasterResult* obj, btScalar* value);
	EXPORT void btVehicleRaycaster_btVehicleRaycasterResult_delete(btVehicleRaycaster_btVehicleRaycasterResult* obj);
	EXPORT void* btVehicleRaycaster_castRay(btVehicleRaycaster* obj, btScalar* from, btScalar* to, btVehicleRaycaster_btVehicleRaycasterResult* result);
