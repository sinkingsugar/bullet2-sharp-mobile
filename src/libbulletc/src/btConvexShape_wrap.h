...
extern "C"
{
	EXPORT void btConvexShape_batchedUnitVectorGetSupportingVertexWithoutMargin(btConvexShape* obj, btVector3* vectors, btVector3* supportVerticesOut, int numVectors);
	EXPORT void btConvexShape_getAabbNonVirtual(btConvexShape* obj, btScalar* t, btScalar* aabbMin, btScalar* aabbMax);
	EXPORT void btConvexShape_getAabbSlow(btConvexShape* obj, btScalar* t, btScalar* aabbMin, btScalar* aabbMax);
