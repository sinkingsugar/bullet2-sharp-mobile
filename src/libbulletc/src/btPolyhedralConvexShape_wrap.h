...
extern "C"
{
	...
	EXPORT bool btPolyhedralConvexShape_isInside(btPolyhedralConvexShape* obj, btScalar* pt, btScalar tolerance);

	EXPORT void btPolyhedralConvexAabbCachingShape_getNonvirtualAabb(btPolyhedralConvexAabbCachingShape* obj, btScalar* trans, btScalar* aabbMin, btScalar* aabbMax, btScalar margin);
