...
extern "C"
{
	...
	EXPORT void btGImpactShapeInterface_rayTest(btGImpactShapeInterface* obj, btScalar* rayFrom, btScalar* rayTo, btCollisionWorld_RayResultCallback* resultCallback);
	...
	EXPORT btGImpactCompoundShape_CompoundPrimitiveManager* btGImpactCompoundShape_CompoundPrimitiveManager_new(btGImpactCompoundShape_CompoundPrimitiveManager* compound);
	...
	EXPORT btGImpactMeshShapePart_TrimeshPrimitiveManager* btGImpactMeshShapePart_TrimeshPrimitiveManager_new2(btGImpactMeshShapePart_TrimeshPrimitiveManager* manager);
	...
	EXPORT void btGImpactMeshShapePart_TrimeshPrimitiveManager_setIndexbase(btGImpactMeshShapePart_TrimeshPrimitiveManager* obj, unsigned char* value);
	...
	EXPORT void btGImpactMeshShapePart_TrimeshPrimitiveManager_setScale(btGImpactMeshShapePart_TrimeshPrimitiveManager* obj, btScalar* value);
	...
	EXPORT void btGImpactMeshShapePart_TrimeshPrimitiveManager_setVertexbase(btGImpactMeshShapePart_TrimeshPrimitiveManager* obj, unsigned char* value);
