...
extern "C"
{
	...
	EXPORT void btBroadphaseProxy_setAabbMax(btBroadphaseProxy* obj, btScalar* value);
	EXPORT void btBroadphaseProxy_setAabbMin(btBroadphaseProxy* obj, btScalar* value);
	...
	EXPORT btBroadphasePairSortPredicate* btBroadphasePairSortPredicate_new();
	EXPORT void btBroadphasePairSortPredicate_delete(btBroadphasePairSortPredicate* obj);
}
