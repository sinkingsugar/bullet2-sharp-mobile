...
extern "C"
{
	...
	EXPORT void btPoint2PointConstraint_getInfo2NonVirtual(btPoint2PointConstraint* obj, btTypedConstraint_btConstraintInfo2* info, btScalar* body0_trans, btScalar* body1_trans);
