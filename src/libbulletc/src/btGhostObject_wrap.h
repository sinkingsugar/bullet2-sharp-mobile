...
extern "C"
{
	...
	EXPORT void btGhostObject_convexSweepTest(btGhostObject* obj, btConvexShape* castShape, btScalar* convexFromWorld, btScalar* convexToWorld, btCollisionWorld_ConvexResultCallback* resultCallback, btScalar allowedCcdPenetration);
	EXPORT void btGhostObject_convexSweepTest2(btGhostObject* obj, btConvexShape* castShape, btScalar* convexFromWorld, btScalar* convexToWorld, btCollisionWorld_ConvexResultCallback* resultCallback);
	...
	EXPORT void btGhostObject_rayTest(btGhostObject* obj, btScalar* rayFromWorld, btScalar* rayToWorld, btCollisionWorld_RayResultCallback* resultCallback);
