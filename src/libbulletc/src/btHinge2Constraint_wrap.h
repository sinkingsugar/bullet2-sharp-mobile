...
extern "C"
{
	...
	EXPORT btScalar* btHinge2Constraint_getAnchor(btHinge2Constraint* obj);
	EXPORT btScalar* btHinge2Constraint_getAnchor2(btHinge2Constraint* obj);
	...
	EXPORT btScalar* btHinge2Constraint_getAxis1(btHinge2Constraint* obj);
	EXPORT btScalar* btHinge2Constraint_getAxis2(btHinge2Constraint* obj);
