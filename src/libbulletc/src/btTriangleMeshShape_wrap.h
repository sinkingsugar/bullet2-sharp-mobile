...
extern "C"
{
	...
	EXPORT void btTriangleMeshShape_localGetSupportingVertex(btTriangleMeshShape* obj, btScalar* vec);
	EXPORT void btTriangleMeshShape_localGetSupportingVertexWithoutMargin(btTriangleMeshShape* obj, btScalar* vec);
